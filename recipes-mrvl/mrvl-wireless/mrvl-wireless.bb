...
FILES_${PN} = "${base_libdir}/firmware/nxp ${base_libdir}/modules/mrvl"
...
do_install() {
    ...
    install -m 0777 ${WORKDIR}/sduart8987_combo_jody-w2-sdiouart.bin ${D}${base_libdir}/firmware/nxp/
    install -m 0777 ${WORKDIR}/WlanCalData_ext_5pF.conf ${D}${base_libdir}/firmware/nxp/
